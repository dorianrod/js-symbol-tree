...
class SymbolTree {
         ...
         */
        sibblingLength(node) {
                return [...this.previousSiblingsIterator(node)].length + [...this.nextSiblingsIterator(node)].length
        }
        ...
        getPath(node) {
            ...
            const parentPath = (parent ? this.getPath(parent) : sibblingIndex)
            return parentPath + (currentNodeIndex !== "" ? "." : "") + currentNodeIndex;
        }
        ...
        getByPath(path, node = null) {
            ...
            const nextNode = node ? childrenToArray[currentPath] : currentNode
        ...
        toTreeObject(originalNode, options) {
                ...
                json[childrenAttribute] = this.childrenToArray(node).map((child) => {
